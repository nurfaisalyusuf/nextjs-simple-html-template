...
export class ElementPage extends Component {
	...
	<section className="button-area">
		<div className="container border-top-generic">
			...
			<div className="button-group-area mt-40">
				<a href="#" className="genric-btn default circle arrow">Default<span className="ti-arrow-right"></span></a>
				<a href="#" className="genric-btn primary circle arrow">Primary<span className="ti-arrow-right"></span></a>
				<a href="#" className="genric-btn success circle arrow">Success<span className="ti-arrow-right"></span></a>
				<a href="#" className="genric-btn info circle arrow">Info<span className="ti-arrow-right"></span></a>
				<a href="#" className="genric-btn warning circle arrow">Warning<span className="ti-arrow-right"></span></a>
				<a href="#" className="genric-btn danger circle arrow">Danger<span className="ti-arrow-right"></span></a>
			</div>
			<div className="button-group-area mt-10">
				<a href="#" className="genric-btn default-border circle arrow">Default<span className="ti-arrow-right"></span></a>
				<a href="#" className="genric-btn primary-border circle arrow">Primary<span className="ti-arrow-right"></span></a>
				<a href="#" className="genric-btn success-border circle arrow">Success<span className="ti-arrow-right"></span></a>
				<a href="#" className="genric-btn info-border circle arrow">Info<span className="ti-arrow-right"></span></a>
				<a href="#" className="genric-btn warning-border circle arrow">Warning<span className="ti-arrow-right"></span></a>
				<a href="#" className="genric-btn danger-border circle arrow">Danger<span className="ti-arrow-right"></span></a>
			</div>
			<div className="button-group-area mt-40">
		...
		<div className="container">
			<div className="section-top-border">
				...
				<div className="row">
					<div className="col-md-3">
						<img src="/static/img/elements/d.jpg" alt="" className="img-fluid"/>
					</div>
			...
			<div className="section-top-border text-right">
				...
				<div className="row">
					<div className="col-md-9">
						<p className="text-right">Over time, even the most sophisticated, memory packed computer can begin to run slow if we
						...
						<p className="text-right">Before we discuss all of the things that could be affecting your PC’s performance, let’s
				...
				<div className="progress-table-wrap">
					<div className="progress-table">
						...
						<div className="table-row">
							...
							<div className="country"> <img src="/static/img/elements/f1.jpg" alt="flag"/>Canada</div>
							<div className="visit">645032</div>
							<div className="percentage">
								<div className="progress">
									<div className="progress-bar color-1" role="progressbar" style={{width: "80%"}} aria-valuenow="80" aria-valuemin="0"
						...
						<div className="table-row">
							...
							<div className="country"> <img src="/static/img/elements/f2.jpg" alt="flag" />Canada</div>
							<div className="visit">645032</div>
							<div className="percentage">
								<div className="progress">
									<div className="progress-bar color-2" role="progressbar" style={{width: "30%"}} aria-valuenow="30" aria-valuemin="0"
									 aria-valuemax="100"></div>
								</div>
							</div>
						</div>
						<div className="table-row">
							...
							<div className="country"> <img src="/static/img/elements/f3.jpg" alt="flag"/>Canada</div>
							<div className="visit">645032</div>
							<div className="percentage">
								<div className="progress">
									<div className="progress-bar color-3" role="progressbar" style={{width: "55%"}} aria-valuenow="55" aria-valuemin="0"
									 aria-valuemax="100"></div>
								</div>
							</div>
						</div>
						<div className="table-row">
							...
							<div className="country"> <img src="/static/img/elements/f4.jpg" alt="flag"/>Canada</div>
							<div className="visit">645032</div>
							<div className="percentage">
								<div className="progress">
									<div className="progress-bar color-4" role="progressbar" style={{width: "60%"}} aria-valuenow="60" aria-valuemin="0"
									 aria-valuemax="100"></div>
								</div>
							</div>
						</div>
						<div className="table-row">
							...
							<div className="country"> <img src="/static/img/elements/f5.jpg" alt="flag"/>Canada</div>
							<div className="visit">645032</div>
							<div className="percentage">
								<div className="progress">
									<div className="progress-bar color-5" role="progressbar" style={{width: "40%"}} aria-valuenow="40" aria-valuemin="0"
									 aria-valuemax="100"></div>
								</div>
							</div>
						</div>
						<div className="table-row">
							...
							<div className="country"> <img src="/static/img/elements/f6.jpg" alt="flag"/>Canada</div>
							<div className="visit">645032</div>
							<div className="percentage">
								<div className="progress">
									<div className="progress-bar color-6" role="progressbar" style={{width: "70%"}} aria-valuenow="70" aria-valuemin="0"
									 aria-valuemax="100"></div>
								</div>
							</div>
						</div>
						<div className="table-row">
							...
							<div className="country"> <img src="/static/img/elements/f7.jpg" alt="flag"/>Canada</div>
							<div className="visit">645032</div>
							<div className="percentage">
								<div className="progress">
									<div className="progress-bar color-7" role="progressbar" style={{width: "30%"}} aria-valuenow="30" aria-valuemin="0"
									 aria-valuemax="100"></div>
								</div>
							</div>
						</div>
						<div className="table-row">
							...
							<div className="country"> <img src="/static/img/elements/f8.jpg" alt="flag"/>Canada</div>
							<div className="visit">645032</div>
							<div className="percentage">
								<div className="progress">
									<div className="progress-bar color-8" role="progressbar" style={{width: "60%"}} aria-valuenow="60" aria-valuemin="0"
									 aria-valuemax="100"></div>
								</div>
							</div>
						</div>
			...
			<div className="section-top-border">
				...
				<div className="row gallery-item">
					<div className="col-md-4">
						<a href="/static/img/elements/g1.jpg" className="img-gal">
							<div className="single-gallery-image" style={{background: "url(/static/img/elements/g1.jpg)"}}></div>
						</a>
					</div>
					<div className="col-md-4">
						<a href="/static/img/elements/g2.jpg" className="img-gal">
							<div className="single-gallery-image" style={{background: "url(/static/img/elements/g2.jpg)"}}></div>
						</a>
					</div>
					<div className="col-md-4">
						<a href="/static/img/elements/g3.jpg" className="img-gal">
							<div className="single-gallery-image" style={{background: "url(/static/img/elements/g3.jpg)"}}></div>
						</a>
					</div>
					<div className="col-md-6">
						<a href="/static/img/elements/g4.jpg" className="img-gal">
							<div className="single-gallery-image" style={{background: "url(/static/img/elements/g4.jpg)"}}></div>
						</a>
					</div>
					<div className="col-md-6">
						<a href="/static/img/elements/g5.jpg" className="img-gal">
							<div className="single-gallery-image" style={{background: "url(/static/img/elements/g5.jpg)"}}></div>
						</a>
					</div>
					<div className="col-md-4">
						<a href="/static/img/elements/g6.jpg" className="img-gal">
							<div className="single-gallery-image" style={{background: "url(/static/img/elements/g6.jpg)"}}></div>
						</a>
					</div>
					<div className="col-md-4">
						<a href="/static/img/elements/g7.jpg" className="img-gal">
							<div className="single-gallery-image" style={{background: "url(/static/img/elements/g7.jpg)"}}></div>
						</a>
					</div>
					<div className="col-md-4">
						<a href="/static/img/elements/g8.jpg" className="img-gal">
							<div className="single-gallery-image" style={{background: "url(/static/img/elements/g8.jpg)"}}></div>
						</a>
					</div>
				</div>
			</div>
				...
				<div className="row">
					<div className="col-lg-8 col-md-8">
						...
						<form action="#">
							...
							<div className="input-group-icon mt-10">
								<div className="icon"><i className="ti-location-arrow" aria-hidden="true"></i></div>
							...
							<div className="input-group-icon mt-10">
								<div className="icon"><i className="ti-map" aria-hidden="true"></i></div>
