                            ...
                            <div className="col-lg-8 posts-list">
                                <div className="single-post row">
                                    ...
                                    <div className="col-lg-9 col-md-9 blog_details">
                                        ...
                                        <p>
                                            Boot camps have its supporters and
                                            ...
                                            self-imposed MCSE training. who has
                                            the willpower to actually sit
                                    ...
                                    <div className="col-lg-12">
                                        ...
                                        <div className="row">
                                            <div className="col-6">
                                                <img
                                                    className="img-fluid"
                                                    src="/static/img/blog/post-img1.jpg"
                                                    alt=""
                                                />
                                            </div>
                                            <div className="col-6">
                                                <img
                                                    className="img-fluid"
                                                    src="/static/img/blog/post-img2.jpg"
                                                    alt=""
                                                />
                                            </div>
                                            <div className="col-lg-12 mt-25">
                                                <p>
                                                    MCSE boot camps have its
                                                    supporters and its
                                                    detractors. Some people do
                                                    not understand why you
                                                    should have to spend money
                                                    on boot camp when you can
                                                    get the MCSE study materials
                                                    yourself at a fraction of
                                                    the camp price. However, who
                                                    has the willpower.
                                                </p>
                                                <p>
                                                    MCSE boot camps have its
                                ...
                                <div className="navigation-area">
                                    <div className="row">
                                        <div className="col-lg-6 col-md-6 col-12 nav-left flex-row d-flex justify-content-start align-items-center">
                                            ...
                                            <div className="arrow">
                                                <a href="#">
                                                    <i className="text-white ti-arrow-left"></i>
                                                </a>
                                            </div>
                                        ...
                                        <div className="col-lg-6 col-md-6 col-12 nav-right flex-row d-flex justify-content-end align-items-center">
                                            ...
                                            <div className="arrow">
                                                <a href="#">
                                                    <i className="text-white ti-arrow-right"></i>
                                                </a>
                                            </div>
                                            <div className="thumb">
                                                <a href="#">
                                ...
                                <div className="blog_right_sidebar">
                                    ...
                                    <aside className="single_sidebar_widget author_widget">
                                        <img
                                            ...
                                            src="/static/img/blog/author.png"
                                            alt=""
                                        />
                                    ...
                                    <aside className="single_sidebar_widget popular_post_widget">
                                        ...
                                        <div className="media post_item">
                                            <img
                                                src="/static/img/blog/popular-post/post1.jpg"
                                                alt="post"
                                            />
                                        ...
                                        <div className="media post_item">
                                            <img
                                                src="/static/img/blog/popular-post/post2.jpg"
                                                alt="post"
                                            />
                                            <div className="media-body">
                                                <a href="blog-details.html">
                                        ...
                                        <div className="media post_item">
                                            <img
                                                src="/static/img/blog/popular-post/post3.jpg"
                                                alt="post"
                                            />
                                            <div className="media-body">
                                                <a href="blog-details.html">
                                        ...
                                        <div className="media post_item">
                                            <img
                                                src="/static/img/blog/popular-post/post4.jpg"
                                                alt="post"
                                            />
                                            <div className="media-body">
                                                <a href="blog-details.html">
