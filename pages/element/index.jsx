        ...
        return (
            <Layout>
                ...
                <section className="sample-text-area">
                    <div className="container">
                        <h3 className="text-heading title_color">
                            Text Sample
                        </h3>
                        <p className="sample-text">
                            Every avid independent filmmaker has <b>Bold</b>{" "}
                            about making that <i>Italic</i> interest
                            documentary, or short film to show off their
                            creative prowess. Many have great ideas and want to
                            “wow” the<sup>Superscript</sup> scene, or video
                            renters with their big project. But once you have
                            the<sub>Subscript</sub> “in the can” (no easy feat),
                            how do you move from a <del>Strike</del> through of
                            master DVDs with the <u>“Underline”</u> marked
                            hand-written title inside a secondhand CD case, to a
                            pile of cardboard boxes full of shiny new,
                            retail-ready DVDs, with UPC barcodes and polywrap
                            sitting on your doorstep? You need to create
                            eye-popping artwork and have your project
                            replicated. Using a reputable full service DVD
                            Replication company like PacificDisc, Inc. to
                            partner with is certainly a helpful option to ensure
                            a professional end result, but to help with your DVD
                            replication project, here are 4 easy steps to follow
                ...
                <section className="button-area">
                    <div className="container border-top-generic">
                        ...
                        <div className="button-group-area mt-10">
                            <a
                                href="#"
                                className="genric-btn default-border radius"
                            >
                                Default
                            </a>
                            <a
                            ...
                            <a
                                href="#"
                                className="genric-btn info-border radius"
                            >
                                Info
                            </a>
                            <a
                                href="#"
                                className="genric-btn warning-border radius"
                            >
                                Warning
                            </a>
                            <a
                                href="#"
                                className="genric-btn danger-border radius"
                            >
                                Danger
                            </a>
                            <a
                                href="#"
                                className="genric-btn link-border radius"
                            >
                                Link
                            </a>
                            <a href="#" className="genric-btn disable radius">
                        ...
                        <div className="button-group-area mt-10">
                            <a
                                href="#"
                                className="genric-btn default-border circle"
                            >
                                Default
                            </a>
                            <a
                            ...
                            <a
                                href="#"
                                className="genric-btn link-border circle"
                            >
                                Link
                            </a>
                            <a href="#" className="genric-btn disable circle">
                        ...
                        <div className="button-group-area mt-40">
                            <a
                                href="#"
                                className="genric-btn default circle arrow"
                            >
                                Default<span className="ti-arrow-right"></span>
                            </a>
                            <a
                                href="#"
                                className="genric-btn primary circle arrow"
                            >
                                Primary<span className="ti-arrow-right"></span>
                            </a>
                            <a
                                href="#"
                                className="genric-btn success circle arrow"
                            >
                                Success<span className="ti-arrow-right"></span>
                            </a>
                            <a
                                href="#"
                                className="genric-btn info circle arrow"
                            >
                                Info<span className="ti-arrow-right"></span>
                            </a>
                            <a
                                href="#"
                                className="genric-btn warning circle arrow"
                            >
                                Warning<span className="ti-arrow-right"></span>
                            </a>
                            <a
                                href="#"
                                className="genric-btn danger circle arrow"
                            >
                                Danger<span className="ti-arrow-right"></span>
                            </a>
                        </div>
                        <div className="button-group-area mt-10">
                            <a
                                href="#"
                                className="genric-btn default-border circle arrow"
                            >
                                Default<span className="ti-arrow-right"></span>
                            </a>
                            <a
                            ...
                            <a
                                href="#"
                                className="genric-btn warning-border circle arrow"
                            >
                                Warning<span className="ti-arrow-right"></span>
                            </a>
                            <a
                                href="#"
                                className="genric-btn danger-border circle arrow"
                            >
                                Danger<span className="ti-arrow-right"></span>
                            </a>
                        </div>
                        ...
                        <div className="button-group-area mt-10">
                            <a
                                href="#"
                                className="genric-btn primary-border e-large"
                            >
                                Extra Large
                            </a>
                            <a
                                href="#"
                                className="genric-btn success-border large"
                            >
                                Large
                            </a>
                            <a href="#" className="genric-btn primary-border">
                            ...
                            <a
                                href="#"
                                className="genric-btn success-border medium"
                            >
                                Medium
                            </a>
                            <a
                    ...
                    <div className="container">
                        <div className="section-top-border">
                            ...
                            <div className="row">
                                ...
                                <div className="col-md-9 mt-sm-20 left-align-p">
                                    <p>
                                        Recently, the US Federal government
                                        banned online casinos from operating in
                                        America by making it illegal to transfer
                                        money to them through any US bank or
                                        payment system. As a result of this law,
                                        most of the popular online casino
                                        networks such as Party Gaming and
                                        PlayTech left the United States.
                                        Overnight, online casino players found
                                        themselves being chased by the Federal
                                        government. But, after a fortnight, the
                                        online casino industry came up with a
                                        solution and new online casinos started
                                        taking root. These began to operate
                                        under a different business umbrella, and
                                        by doing that, rendered the transfer of
                                        money to and from them legal. A major
                                        part of this was enlisting electronic
                                        banking systems that would accept this
                                        new clarification and start doing
                                        business with me. Listed in this article
                                        are the electronic banking systems that
                            ...
                            <div className="row">
                                <div className="col-md-9">
                                    <p className="text-right">
                                        ...
                                        memory packed computer can begin to run
                                        slow if we don’t do something to prevent
                                        it. The reason why has less to do with
                                        how computers are made and how they age
                                        and more to do with the way we use them.
                                        You see, all of the daily tasks that we
                                        do on our PC from running programs to
                                        downloading and deleting software can
                                        make our computer sluggish. To keep this
                                        from happening, you need to understand
                                        the reasons why your PC is getting
                                        slower and do something to keep your PC
                                        running at its best. You can do this
                                        through regular maintenance and PC
                                        performance optimization programs
                                    </p>
                                    <p className="text-right">
                                        Before we discuss all of the things that
                                        could be affecting your PC’s
                                        performance, let’s talk a little about
                                        what symptoms
                                    </p>
                                </div>
                                <div className="col-md-3">
                            ...
                            <div className="row">
                                <div className="col-md-4">
                                    <div className="single-defination">
                                        ...
                                        <p>
                                            Recently, the US Federal government
                                            banned online casinos from operating
                                            in America by making it illegal to
                                            transfer money to them through any
                                            US bank or payment system. As a
                                            result of this law, most of the
                                            popular online casino networks
                                        </p>
                                    </div>
                                </div>
                                <div className="col-md-4">
                                ...
                                <div className="progress-table">
                                    ...
                                    <div className="table-row">
                                        ...
                                        <div className="country">
                                            {" "}
                                            <img
                                                src="/static/img/elements/f1.jpg"
                                                alt="flag"
                                            />
                                            Canada
                                        </div>
                                    ...
                                    <div className="table-row">
                                        ...
                                        <div className="country">
                                            {" "}
                                            <img
                                                src="/static/img/elements/f2.jpg"
                                                alt="flag"
                                            />
                                            Canada
                                        </div>
                                    ...
                                    <div className="table-row">
                                        ...
                                        <div className="country">
                                            {" "}
                                            <img
                                                src="/static/img/elements/f3.jpg"
                                                alt="flag"
                                            />
                                            Canada
                                        </div>
                                    ...
                                    <div className="table-row">
                                        ...
                                        <div className="country">
                                            {" "}
                                            <img
                                                src="/static/img/elements/f4.jpg"
                                                alt="flag"
                                            />
                                            Canada
                                        </div>
                                    ...
                                    <div className="table-row">
                                        ...
                                        <div className="country">
                                            {" "}
                                            <img
                                                src="/static/img/elements/f5.jpg"
                                                alt="flag"
                                            />
                                            Canada
                                        </div>
                                    ...
                                    <div className="table-row">
                                        ...
                                        <div className="country">
                                            {" "}
                                            <img
                                                src="/static/img/elements/f6.jpg"
                                                alt="flag"
                                            />
                                            Canada
                                        </div>
                                    ...
                                    <div className="table-row">
                                        ...
                                        <div className="country">
                                            {" "}
                                            <img
                                                src="/static/img/elements/f7.jpg"
                                                alt="flag"
                                            />
                                            Canada
                                        </div>
                                    ...
                                    <div className="table-row">
                                        ...
                                        <div className="country">
                                            {" "}
                                            <img
                                                src="/static/img/elements/f8.jpg"
                                                alt="flag"
                                            />
                                            Canada
                                        </div>
                        ...
                        <div className="section-top-border">
                            ...
                            <div className="row gallery-item">
                                <div className="col-md-4">
                                    <a
                                        href="/static/img/elements/g1.jpg"
                                        className="img-gal"
                                    >
                                        <div
                                            ...
                                            style={{
                                                background:
                                                    "url(/static/img/elements/g1.jpg)",
                                            }}
                                        ></div>
                                    </a>
                                </div>
                                <div className="col-md-4">
                                    <a
                                        href="/static/img/elements/g2.jpg"
                                        className="img-gal"
                                    >
                                        <div
                                            className="single-gallery-image"
                                            style={{
                                                background:
                                                    "url(/static/img/elements/g2.jpg)",
                                            }}
                                        ></div>
                                    </a>
                                </div>
                                <div className="col-md-4">
                                    <a
                                        href="/static/img/elements/g3.jpg"
                                        className="img-gal"
                                    >
                                        <div
                                            className="single-gallery-image"
                                            style={{
                                                background:
                                                    "url(/static/img/elements/g3.jpg)",
                                            }}
                                        ></div>
                                    </a>
                                </div>
                                <div className="col-md-6">
                                    <a
                                        href="/static/img/elements/g4.jpg"
                                        className="img-gal"
                                    >
                                        <div
                                            className="single-gallery-image"
                                            style={{
                                                background:
                                                    "url(/static/img/elements/g4.jpg)",
                                            }}
                                        ></div>
                                    </a>
                                </div>
                                <div className="col-md-6">
                                    <a
                                        href="/static/img/elements/g5.jpg"
                                        className="img-gal"
                                    >
                                        <div
                                            className="single-gallery-image"
                                            style={{
                                                background:
                                                    "url(/static/img/elements/g5.jpg)",
                                            }}
                                        ></div>
                                    </a>
                                </div>
                                <div className="col-md-4">
                                    <a
                                        href="/static/img/elements/g6.jpg"
                                        className="img-gal"
                                    >
                                        <div
                                            className="single-gallery-image"
                                            style={{
                                                background:
                                                    "url(/static/img/elements/g6.jpg)",
                                            }}
                                        ></div>
                                    </a>
                                </div>
                                <div className="col-md-4">
                                    <a
                                        href="/static/img/elements/g7.jpg"
                                        className="img-gal"
                                    >
                                        <div
                                            className="single-gallery-image"
                                            style={{
                                                background:
                                                    "url(/static/img/elements/g7.jpg)",
                                            }}
                                        ></div>
                                    </a>
                                </div>
                                <div className="col-md-4">
                                    <a
                                        href="/static/img/elements/g8.jpg"
                                        className="img-gal"
                                    >
                                        <div
                                            className="single-gallery-image"
                                            style={{
                                                background:
                                                    "url(/static/img/elements/g8.jpg)",
                                            }}
                                        ></div>
                                    </a>
                                </div>
                        ...
                        <div className="section-top-border">
                            <div className="row">
                                <div className="col-lg-4 col-sm-6 typo-sec">
                                    <h3 className="mb-20 title_color">
                                        Typography
                                    </h3>
                                    <div className="typography">
                                        <h1 className="typo-list">
                                            This is header 01
                                        </h1>
                                        <h2 className="typo-list">
                                            This is header 02
                                        </h2>
                                        <h3 className="typo-list">
                                            This is header 03
                                        </h3>
                                        <h4 className="typo-list">
                                            This is header 04
                                        </h4>
                                        <h5 className="typo-list">
                                            This is header 01
                                        </h5>
                                        <h6 className="typo-list">
                                            This is header 01
                                        </h6>
                                    </div>
                                </div>
                                <div className="col-lg-4 col-sm-6 mt-sm-30 typo-sec">
                                    ...
                                    <div className="">
                                        <ul className="unordered-list">
                                            <li>Fta Keys</li>
                                            <li>
                                                For Women Only Your Computer
                                                Usage
                                            </li>
                                            <li>
                                                Facts Why Inkjet Printing Is
                                                Very Appealing
                                                <ul>
                                                    <li>
                                            ...
                                            <li>
                                                Make Myspace Your Best Designed
                                                Space
                                            </li>
                                            <li>
